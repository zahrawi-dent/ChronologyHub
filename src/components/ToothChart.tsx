...
//
//   // Component for individual tooth to reduce repetition
//   const ToothElement = (props: { tooth: ToothData }) => (
//     <div
//       class={`
//         w-12 h-16 rounded-lg border-2 cursor-pointer transition-all duration-200 flex flex-col items-center justify-center text-xs font-medium shadow-sm
//         ${getCategoryColor(props.tooth.category)}
//         ${props.selectedTooth?.id === props.tooth.id ? 'ring-2 ring-primary ring-offset-2 scale-105' : ''}
//       `}
//       onClick={() => props.onToothSelect?.(props.tooth)}
//       title={`${props.tooth.name} - ${props.tooth.notation[notation()]}`}
//     >
//       <div class="text-[10px] font-bold">
//         {props.tooth.notation[notation()]}
//       </div>
//       <div class="text-[8px] text-center leading-tight">
//         {props.tooth.name.split(' ')[0]}
//       </div>
//       {props.tooth.type === 'primary' && (
//         <Badge variant="secondary">
//           P
//         </Badge>
//       )}
